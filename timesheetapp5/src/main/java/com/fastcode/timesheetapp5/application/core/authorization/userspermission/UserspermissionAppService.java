...
import com.fastcode.timesheetapp5.domain.core.authorization.userspermission.QUserspermissionEntity;
        ...
        for (Map.Entry<String, SearchFields> details : map.entrySet()) {
            if (details.getKey().replace("%20", "").trim().equals("permissionId")) {
                if (
                    ...
                    userspermission.permissionId.eq(Long.valueOf(details.getValue().getSearchValue()))
                ); else if (
                    details.getValue().getOperator().equals("notEqual") &&
                    StringUtils.isNumeric(details.getValue().getSearchValue())
                ) builder.and(
                    userspermission.permissionId.ne(Long.valueOf(details.getValue().getSearchValue()))
            ...
            if (details.getKey().replace("%20", "").trim().equals("revoked")) {
                if (
                    ...
                    userspermission.revoked.eq(Boolean.parseBoolean(details.getValue().getSearchValue()))
                ); else if (
                    details.getValue().getOperator().equals("notEqual") &&
                    (
                        details.getValue().getSearchValue().equalsIgnoreCase("true") ||
            ...
            if (details.getKey().replace("%20", "").trim().equals("usersId")) {
                if (
                    details.getValue().getOperator().equals("equals") &&
                    StringUtils.isNumeric(details.getValue().getSearchValue())
                ) builder.and(userspermission.usersId.eq(Long.valueOf(details.getValue().getSearchValue()))); else if (
                    details.getValue().getOperator().equals("notEqual") &&
                    StringUtils.isNumeric(details.getValue().getSearchValue())
                ) builder.and(userspermission.usersId.ne(Long.valueOf(details.getValue().getSearchValue()))); else if (
                    ...
                    if (
                        ...
                        userspermission.usersId.goe(Long.valueOf(details.getValue().getStartingValue()))
                    ); else if (StringUtils.isNumeric(details.getValue().getEndingValue())) builder.and(
                        userspermission.usersId.loe(Long.valueOf(details.getValue().getEndingValue()))
                    );
                }
            }
            ...
            if (details.getKey().replace("%20", "").trim().equals("permission")) {
                if (details.getValue().getOperator().equals("contains")) builder.and(
                    ...
                    userspermission.permission.displayName.eq(details.getValue().getSearchValue())
                ); else if (details.getValue().getOperator().equals("notEqual")) builder.and(
                    userspermission.permission.displayName.ne(details.getValue().getSearchValue())
                );
            }
            if (details.getKey().replace("%20", "").trim().equals("users")) {
                if (details.getValue().getOperator().equals("contains")) builder.and(
                    ...
                    userspermission.users.username.eq(details.getValue().getSearchValue())
                ); else if (details.getValue().getOperator().equals("notEqual")) builder.and(
                    userspermission.users.username.ne(details.getValue().getSearchValue())
                );
            }
        }
