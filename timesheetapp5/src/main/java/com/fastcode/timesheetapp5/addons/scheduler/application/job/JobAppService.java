...
import com.fastcode.timesheetapp5.Timesheetapp5Application;
import com.fastcode.timesheetapp5.addons.scheduler.CGenClassLoader;
import com.fastcode.timesheetapp5.addons.scheduler.application.job.dto.*;
import com.fastcode.timesheetapp5.addons.scheduler.constants.QuartzConstants;
import com.fastcode.timesheetapp5.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.timesheetapp5.addons.scheduler.domain.job.JobEntity;
import com.fastcode.timesheetapp5.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.timesheetapp5.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.timesheetapp5.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.timesheetapp5.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
import com.fastcode.timesheetapp5.commons.search.SearchFields;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = Timesheetapp5Application.class.getResource("/").toURI();
