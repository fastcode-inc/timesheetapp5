...
import com.fastcode.timesheetapp5.domain.core.authorization.users.UsersEntity;
import com.fastcode.timesheetapp5.domain.core.authorization.userspreference.IUserspreferenceManager;
...
public class UsersControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table timesheet.users").executeUpdate();
        em.createNativeQuery("truncate table timesheet.userspreference").executeUpdate();
