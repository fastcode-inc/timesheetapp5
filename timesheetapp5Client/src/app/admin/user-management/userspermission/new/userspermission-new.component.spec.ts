  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [UserspermissionNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [UserspermissionService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [UserspermissionNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [UserspermissionService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
