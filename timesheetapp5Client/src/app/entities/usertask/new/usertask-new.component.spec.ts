  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [UsertaskNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [UsertaskService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [UsertaskNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [UsertaskService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
