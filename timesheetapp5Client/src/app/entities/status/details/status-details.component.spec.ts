...
import { IStatus, StatusService, StatusDetailsComponent, StatusListComponent } from '../';
...
describe('StatusDetailsComponent', () => {
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StatusDetailsComponent, DetailsComponent],
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StatusDetailsComponent, StatusListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: 'status', component: StatusDetailsComponent },
            { path: 'status/:id', component: StatusListComponent },
          ]),
        ],
        providers: [StatusService],
      }).compileComponents();
