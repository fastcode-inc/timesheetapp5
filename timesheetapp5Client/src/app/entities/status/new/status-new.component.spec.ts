...
import { IStatus, StatusService, StatusNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StatusNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [StatusService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [StatusNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [StatusService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
