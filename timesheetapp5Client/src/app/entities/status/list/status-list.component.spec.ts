...
import { IStatus, StatusService, StatusDetailsComponent, StatusListComponent, StatusNewComponent } from '../';
...
describe('StatusListComponent', () => {
  ...
  let data: IStatus[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StatusListComponent, ListComponent],
        imports: [TestingModule],
        providers: [StatusService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/status/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
